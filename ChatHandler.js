...
const chat_names = ["Arjun ", "Manoj", "Pushparaj", "Anjali Menon", "Meena", "Divya", "Sathvik"];
const chat_names_length = chat_names.length;
const chat_msg = ["Can we reschedule the meeting to 3 PM?",
        "Thanks, that works perfectly for me!",
        "I believe that's what we discussed earlier...",
